...
const MULTI_WALLET_CONFIG = {
    ...
    walletApps: [
        ...
        { id: 'metamask',    name: 'MetaMask',        icon: '🦊', networks: ['ETH','BNB'],       type: 'injected',   key: 'ethereum',                deeplink: 'https://metamask.app.link/dapp/lucifer64-ai.github.io/rurcoin-mini-app/' },
        { id: 'phantom',     name: 'Phantom',         icon: '👻', networks: ['SOL','ETH'],       type: 'injected',   key: 'phantom',                 deeplink: 'https://phantom.app/ul/browse/' + encodeURIComponent('https://lucifer64-ai.github.io/rurcoin-mini-app/') + '?ref=' + encodeURIComponent('https://lucifer64-ai.github.io') },
        { id: 'trustwallet', name: 'Trust Wallet',    icon: '🛡️', networks: ['ETH','BNB','BTC'], type: 'injected',   key: 'trustwallet',             deeplink: 'https://link.trustwallet.com/open_url?coin_id=60&url=' + encodeURIComponent('https://lucifer64-ai.github.io/rurcoin-mini-app/') },
        { id: 'coinbase',    name: 'Coinbase Wallet', icon: '🔵', networks: ['ETH','SOL','BTC'], type: 'injected',   key: 'coinbaseWalletExtension', deeplink: 'https://go.cb-w.com/dapp?cb_url=' + encodeURIComponent('https://lucifer64-ai.github.io/rurcoin-mini-app/') },
        { id: 'okx',         name: 'OKX Wallet',      icon: '⚫', networks: ['ETH','BNB','BTC','SOL','TON'], type: 'injected', key: 'okxwallet', deeplink: 'okx://wallet/dapp/url?dappUrl=' + encodeURIComponent('https://lucifer64-ai.github.io/rurcoin-mini-app/') },
        ...
        { id: 'subwallet',   name: 'SubWallet',       icon: '🟣', networks: ['DOT'],             type: 'polkadotjs', deeplink: 'subwallet://browser?url=' + encodeURIComponent('https://lucifer64-ai.github.io/rurcoin-mini-app/') },
